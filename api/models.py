...
class PremiseMain(models.Model):
    ...
    premise_type = models.CharField(max_length=50, unique=True, default='retail_premise')
...
class TenantContractor(models.Model):
    ...
    needed_electric_capacity = models.DecimalField(null=True, max_digits=6, decimal_places=2)
    needed_cooling_capacity = models.DecimalField(null=True, max_digits=6, decimal_places=2)
